...
from warehouse_ddd import model, unit_of_work, services, repository

def test_uow_can_retrieve_a_batch_and_allocate_to_it(postgres_session):
    helpers.insert_batch_uow(postgres_session, "batch-uow", "HIPSTER-WORKBENCH", 100, None)
    ...
    batchref = helpers.get_allocated_batch_ref(postgres_session, "o-uow", "HIPSTER-WORKBENCH")
...
def test_allocate_returns_allocation():
    ...
    result = services.allocate(model.OrderLine("o1", "CRUNCHY-ARMCHAIR", 10), uow) 
    assert result == "b1"